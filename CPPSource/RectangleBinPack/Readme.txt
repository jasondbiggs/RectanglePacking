The files in this directory were originally cloned from https://github.com/juj/RectangleBinPack but have been modified slightly. The purpose of the library is now to be called from a Wolfram Language LibraryLink paclet.
